...
- **The contracts** — governed by the 3-of-5 multisig described elsewhere here.
- **The money** — held at plain single-signature wallets, as set out above.
- **The reserve asset's own logic** — governed by an upgrade key nobody outside Theo can enumerate.
...
**So: if you have been reading "3-of-5 multisig, no timelock" as the description of who can change this product, that multisig governs neither the money nor the reserve asset.** It is fair to ask what it does govern, and this report cannot tell you.
