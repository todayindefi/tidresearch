...
**If you have been reading "3-of-5 multisig, no timelock" as the description of who can change this product, two further layers are unaccounted for.** This report does not move its scores on that yet, because the deciding fact — who holds those upgrade keys — is checkable and has not been checked, and a score published against a question that could move it materially is worse than an open finding that names the question.
