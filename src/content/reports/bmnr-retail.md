...
asset: "BMNR"
slug: "bmnr"
aliases: ["BMNR", "BitMine", "BitMine Immersion", "BitMine Immersion Technologies"]
chains: []
...
live_dashboard_url: "https://tidresearch.com/dashboards/?asset=bmnr"
featured: false
production: false
issuer: "BitMine Immersion Technologies, Inc."
yield_bearing: false
...
**Live monitoring** of mNAV regime, treasury composition, weekly ETH-buy cadence, and firepower / runway-to-target is on the [live BMNR dashboard](https://tidresearch.com/dashboards/?asset=bmnr) — values in this report are point-in-time anchors; the dashboard reflects current readings.
...
Each of these signals has a live panel on the [BMNR dashboard](https://tidresearch.com/dashboards/?asset=bmnr) — values update daily (price + mNAV) and weekly (8-K refresh of holdings + share count):
