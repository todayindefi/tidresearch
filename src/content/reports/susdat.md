...
**What can be said without projecting: a single counterparty moved this metric 27% in an hour, and eleven hours later almost none of it had come back.** That is enough to establish it cannot carry a trend reading at daily resolution. This report's own qualifier — *"one reading rather than a trend, and a sub-2% cushion is still a sub-2% cushion"* — was the correct instinct, and the "right direction" sentence talked it out of it.
