...
Keep this in proportion. It is why the Issuer axis is 8.0 rather than 8.5, and part of why the overall sits well below 9.0 — a 9.0 asserts essentially no structural concern, and an undelayed single-key upgrade path over $49.9B is a structural concern. It is **not** a reason to prefer a less-reserved dollar: it does not touch backing, redemption or peg, and it does not make a USDC holder worse off than the holder of a smaller stablecoin with a similar or weaker admin posture. USDC remains the top score in this coverage.
