...
**Peg performance** (740 hourly samples): avg **−7 bps** from $1.00, median −6 bps. Tight on average — primary redemption to USDC is open to any holder at NAV (10 min typical, 24h max under stress), which is what keeps secondary discounts arbed away. For comparison: crvUSD median −9 bps, thBILL median −32 bps.
