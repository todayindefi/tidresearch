...
|---|---|---|---|---|
| NAV growth from GPU-loan interest — about 7.8% annualised over the last 76 days; live figure on the dashboard | 30-day epoch FIFO redemption queue, or two Fluid pools plus Curve on the secondary | Up to 30 days on the queue and longer if it rolls; minutes on secondary at retail size | About 10 months | Arbitrum (canonical), plus bridged on Ethereum, Plasma and Base |
...
⚠️ **Re-read 2026-08-25, the gap resolves to $8,403,048 — and it has a direction the "about 3%" framing never states.** The issuer's API reports **$259,880,483** of deployed loans. The vault's `totalAssets` implies **$8.40M more** than the issuer says is out there — **2.35% of assets, $0.026004 per share.** If it resolved against `totalAssets`, NAV would move from **1.107345 to 1.081341**.
