...
axis_exemptions:
  - axis: "4 Dependencies"
    reason: "The YieldBasis credit line is crvUSD's largest single dependency and its dominant issuance source, and neither surface carries a number for it yet — the published body describes it at length and the internal assessment names it a key risk, but no Dependencies score has been authored. Requested from riskAnalyst 2026-09-09; expect a number, not a permanent blank."
