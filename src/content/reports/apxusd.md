...
- **2026-08-23 — collateral figures re-read; scores held (Peg 2.5 / Backing 2.0 / Liquidity 3.0 / Issuer 5.0).** The attested collateral ratio reads **98.017743%** — a **netted** figure excluding **$50.20M of protocol-owned liquidity and $39.92M of minted-but-unsold inventory from both sides**, published beside gross totals. The shortfall on gross supply is **$4,399,857.64**; an independent lower bound reads 98.57%. **Still below par**, and the recovery gate — par or better on the attested feed, sustained — is unmet.
