...
> *Overall score (4.4) is a weighted composite — see §IV for category weights.*
>
> **Rubric note.** This institutional report scores on contract / economic / project, weighted 40/30/30. The [retail companion](/reports/thbill) scores the same asset at **3.5** on the vault-share rubric (stability / contract & admin / redemption / underlying / liquidity / issuer). The two are not in conflict and neither is stale: this page weights smart-contract risk at 40% and is written for a reader who can access primary redemption, while the retail page scores the experience of a holder who cannot redeem and must exit on-DEX. The gap is the value of primary access.
...
**Market cap:** **About $60.6M** at a 2026-08-23 read (58,480,001.56 shares × NAV 1.035365), down from $87.0M five days earlier and from the $130M+ scale of mid-2026. Supply historically churned week-to-week as thUSD-driven primary mints and thUSD/thBILL redemptions moved through Theo's MPC operator. Live supply on the dashboard.
...
- **2026-08-18 — Economic 5.3 → 4.0; Overall 5.1 → 4.8.**
