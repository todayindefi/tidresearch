...
The **6.0/10** reflects that balance — unmatched liquidity and a proven peg against issuer transparency as the dominant residual risk. It lands one notch below fully-audited, US-regulated USDC, and the gap is driven by issuer and backing transparency, not by any weakness in the peg itself.

Tether's **Q2 2026 attestation**, published 2026-07-31, moved one part of that picture. USDT is still over-collateralized and the peg did not budge, but the cushion of reserves above what Tether owes holders **halved in a single quarter**, from a record $8.23 billion to $4.11 billion. Backing was cut from 6.5 to **6.0** on that, and **the overall held at 7.0 at the time** — liquidity and peg resilience were untouched, and one quarter of evidence on one axis does not re-price a decade-proven asset. ⚠️ **Overall has since moved to 6.0 for an unrelated reason** — two axes that had never been measured were measured — **see the Overall row for the current figure.** The detail is in "What backs it" below.
...
✅ **Update 2026-08-25: the cushion has rebuilt, and this is a checked-and-held result rather than a re-rate.** Re-read on 2026-08-16, the excess reserve is **up about 53% off the Q2 low** — a genuine recovery on the axis this report cut in August, and the direction the Backing move was watching for. **Every score holds**, because one quarter's rebuild does not undo the structural point the cut was about: the buffer remains levered to gold and bitcoin, and the composition question is unchanged.

⚠️ **Tether has stated a restore trigger, and it is worth having as a number rather than a sentiment: $8B.** That is roughly the Q1 record, and it is the level at which the cushion returns to where it stood before the halving. **A reader now has a specific figure to check rather than a direction to feel** — and it is the cleanest thing on this page to watch, because it is stated by the issuer and observable in the next attestation.
...
- Anyone who needs an EU-MiCA-compliant stablecoin. Tether has declined to seek MiCA authorization, and EU venues are acting on it: **Revolut announced a USDT delisting for EU users dated 2026-08-31**, with a staged wind-down converting residual balances to fiat. ⚠️ **That date has passed and the outcome is not verified here.** This page does not claim the delisting completed, and does not claim it was abandoned — **the announcement is the established fact; the execution is unchecked.** If you hold USDT on an EU platform, check your venue's timeline now rather than later.
- Anyone uncomfortable holding the single most systemically concentrated asset in crypto.

## What to watch

- **The Q3 2026 attestation, due around the end of October.** This is now the decisive datapoint. A second consecutive decline in the surplus — or a surplus under about $3 billion, or collateralization under about 101.5% — would argue for a further cut to the overall. ⚠️ **That trigger was written against an overall of 7.0 and has not been re-derived since the number moved to 6.0**, so treat the direction as live and the arithmetic as pending. A rebuild toward $8 billion would argue Q2 was a drawdown artifact and nothing more.
...
- ⚠️ **Whether the Revolut wind-down executed as announced** — its stated date of 2026-08-31 has passed unverified, and it is the first thing to check before this page quotes it again. Then **further EU delistings**, and any sign Tether pursues the GENIUS foreign-issuer pathway for USDT itself rather than ceding the US market to USAT.
...
- **2026-08-25 — admin comparison recorded; no score change.** Set against USDS's 48-hour GSM delay, USDT's upgrade path carries no equivalent notice window.
- **2026-08-23 — reserve composition restated.** Short-term US Treasuries are around **77%** of liabilities counting T-bills and reverse repo together.
- **2026-08-03 — Backing 6.5 → 6.0** following Tether's Q2 2026 attestation; Overall held at 7.0.
