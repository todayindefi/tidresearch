...
- **mNAV (EV/BTC, currently roughly 0.99 — just below parity).** This is the live signal. After recovering to ~1.01 on the 06-29 8-K it has hovered around the **1.0 line** where ATM equity issuance stops being accretive, printing 0.9852 at the 07-17 close with MSTR about flat at $94.85. This is a **watch, not a break**: the cut re-arms only on a **sustained sub-1.0 with the reserve drawing down**, and the reserve is instead building to a record $3.225B — so marks hold. A durable bounce back above ~1.05 reverts the 06-26 parity notch; a sustained sub-1.0 *with reserve drawdown* re-arms the cut; sustained < 0.85 = distress. Use strategy.com's landing-page mNAV as the authoritative reading.
