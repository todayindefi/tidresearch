...
> **June 2026 update (2026-06-26) — scores HELD; data refresh + mNAV-at-floor watch.** A constructive 8-K (period 06-15→06-21) landed against a sharp preferred-stack selloff. **Reserve-positive:** Strategy's USD cash reserve jumped **$1.1B → $1.4B (06-21)** — the largest weekly build in the series — lifting near-term coverage ~7.7 → **~9.8 months** and pushing the zero-issuance BTC-sale window to **≈2027-04**. Strategy bought **+520 BTC** → **~847,362 BTC** via common ATM only; **4th consecutive week of zero preferred issuance** (no forced selling). **Price-event:** MSTR is at **52-week lows (~$94, −9.35% on 06-24)**, BTC ~$61.3K, and the underlying STRC printed an **all-time low (~$80, about −19% to par)**. Critically, **mNAV (EV/BTC) has compressed to ~1.05 — right on the premium floor** (vs ~1.16 mid-June). Above ~1.05 the ATM funding model stays accretive; a crossing into parity would be the regime change to watch — that 1.05 line is now the live signal. **Why scores held:** the MSTR axes measure the issuer's *funding durability*, which this week arguably improved (the $1.4B reserve extends runway, issuance paused not forced, accumulation continued). So all axes are unchanged. The underlying *instrument*, STRC, was rescored down (see [STRCx report](/reports/strcx/)) because it's the thing trading at an all-time low. The $1.4B reserve build is the offsetting positive to the late-June price weakness — this is instrument-price stress with the funding model intact, not a Strategy credit event. *(Prior — 2026-06-07: a ~16% BTC drawdown took MSTR about −21% and STRC sub-par to ~$93.40; overall moved 5.5 → 5.0 then, capped at one notch because mNAV stayed premium.)*
...
As of 2026-06-03 (strategy.com): EV ≈ $67.2B, BTC Reserve ≈ $55.3B, **mNAV ≈ 1.21 — premium**. **Update 2026-06-26:** the late-June selloff (MSTR to 52-week lows, BTC ~$61.3K) has compressed mNAV to **~1.05 — right on the premium floor**. Still premium, so ATM equity issuance stays (marginally) accretive — but the cushion is now thin, and a crossing below ~1.05 toward parity is the binding signal to watch.
...
| Funding model durability | 5.0 | **Held.** mNAV (EV/BTC) has compressed to **~1.05 — the premium floor** (from ~1.21), so the equity ATM leg remains accretive but the cushion is now thin. Offsetting: issuance stayed **paused (4th week, not forced)**, net BTC accumulation continued, and the $1.4B reserve extends runway — the funding model is demonstrably intact, which holds the axis. The fragilities the prior cut named persist: STRC at an all-time low (~$80) while paying 11.5% near its ~14% practical ceiling is the preferred-leg absorption stress, and **mNAV at ~1.05 is now the proximate binding signal** — a sustained crossing below it would force a cut here. |
| Refinancing capacity | 5.5 | **Held.** Demonstrated capacity to retire $1.5B converts at discount (5/26 transaction) — the rolling-refinancing playbook works at current scale, and common-ATM at premium mNAV is the primary leg and it's working. The fresh-STRC-issuance refi leg is more impaired with STRC at an all-time low, so the 2030-wall-via-STRC assumption is less safe — but held this pass because the primary ATM leg functions and the reserve build extended runway. **A sub-1.05 mNAV crossing would force a cut here.** |
...
| **Overall** | **5.0** | **Functional, levered, at the mNAV floor.** Held at 5.0. The equity ATM leg is still accretive at mNAV ~1.05 (primary funding model intact), and this week the issuer's near-term position improved — cash built to $1.4B, issuance paused not forced, BTC accumulation continued. But the premium is now on its floor: mNAV at ~1.05 is the live signal — above it the funding model stays accretive; a crossing into parity would close the accretive equity leg and force BTC sales to service the preferred stack. The underlying STRC (the instrument, not the issuer) is at an all-time low and was rescored down separately. Acceptable as upstream dependency for assets sized appropriately; not investment-grade-equivalent backing for any holding that needs that. |
...
- **mNAV (EV/BTC, currently ~1.05 — on the premium floor).** This is the live signal: above ~1.05 the ATM funding model stays accretive; a sustained crossing into parity (< 1.0) inverts the BTC-bid flywheel and is the regime change to watch; sustained < 0.85 = distress. The late-June selloff pushed mNAV right onto this floor. Use strategy.com's landing-page mNAV as the authoritative reading.
