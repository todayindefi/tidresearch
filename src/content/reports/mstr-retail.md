...
|---|---|---|---|---|
| ~843,775 BTC (flat 07-12, no sale) | ATM equity (ATM resumed $466.7M 07-12) + BTC sales authorized | $3.0B (07-12, record) | $15.5B | $6.7B |
...
- **mNAV (EV/BTC, currently ~0.97–0.98 — just below parity).** This is the live signal. After recovering to ~1.01 on the 06-29 8-K, the ~8% w/w MSTR selloff into 07-12 pushed it **back just below the 1.0 line** where ATM equity issuance stops being accretive. This is a **watch, not a break**: the cut re-arms only on a **sustained sub-1.0 with the reserve drawing down**, and the reserve is instead building to a record $3.0B — so marks hold. A durable bounce back above ~1.05 reverts the 06-26 parity notch; a sustained sub-1.0 *with reserve drawdown* re-arms the cut; sustained < 0.85 = distress. Use strategy.com's landing-page mNAV as the authoritative reading.
...
- **BTC-sale window date.** Currently ≈2028-03 at zero issuance refill / ~20 months (pushed out by the reserve build to a record $3.0B); drift inward to within ~3 months = acute short-term stress. Extension through successful STRC or ATM cash refill = de-risking.
- **Cash balance.** Currently $3.0B (07-12, a record; built from $871M through $2.55B, now under a 12-month-minimum coverage policy); drops below $500M = stress signal (~3-4 months of cash runway at current obligation).
- **BTC count (currently ~843,775, flat 07-12).** The BTC Monetization Program is live but was **not used this week** — Strategy funded dividends via resumed common ATM ($466.7M) and held BTC flat; the 06-29→07-05 week's 3,588-BTC sale was a one-week event, not a run-rate. Watch the running pace of any subsequent weekly draws versus the ATM/STRC reserve refills.
