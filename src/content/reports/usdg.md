...
| Liquidity | **4.5** | ⚠️ **The binding constraint is that the chain holding half the supply cannot absorb its own holders.** X Layer carries **47.98% of supply** and its entire local on-chain stable exit is **~$1.79M at −200bps — 0.11% of its own supply**, and it is a wall rather than a worse price. Aggregate sell-side depth is **$17,751,457 = 0.535%**; **OKX is 39–61% of off-chain exit and X Layer is OKX's chain.** Argued under [3 · Liquidity & Exit](#3--liquidity--exit--45) |
