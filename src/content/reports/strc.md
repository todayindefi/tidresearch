...
On the reserve balance recorded at 2026-08-09 ($4.65B), and assuming **zero new issuance inflow**, that was roughly **45 months** of STRC dividends alone, or about **32 months** of the entire preferred-and-interest bill, on the $10.489B of STRC par reported at 06-30. ⚠️ Those months are now a floor on two counts: the reserve is higher than $4.65B, and the buybacks have since retired roughly 11.7M STRC shares by the issuer's own weekly disclosures — about $1.17B of par — so the annual bill is smaller than the one they were computed against. A restated ratio waits on a share count reconciled across sources rather than a fresh division on either base. Those are stress-scenario watermarks rather than forecasts — in practice Strategy continuously refills cash through issuance — but they establish that the dividend is not close to being unfundable.
