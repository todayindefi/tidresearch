...
> **Current state (2026-08-23) — the ~84% above is a June figure and the collateral has recovered a long way since. No score change.** For apxUSD, read at 2026-08-23T09:45:59Z, the collateral ratio depends on which basis you use, and there are **three**, not two — each with its own shortfall against a supply of about **$312.1M**:
...
⚠️ **Pair each ratio with its own deficit.** They are not interchangeable, and quoting one ratio beside another's dollar figure understates or overstates the gap by up to $1.79M — a mistake this report made earlier on 2026-08-23 and has corrected.
