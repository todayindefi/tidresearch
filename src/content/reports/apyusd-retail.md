...
⚠️ **And the two signer sets overlap, which is the part neither this report nor its sibling has carried.** Walked on 2026-08-23, the 4-of-6 token-governance Safe and the 3-of-6 bridge Safe **share only 3 of 6 owners** — but that overlap is enough to matter, because the bridge Safe's threshold is three. **The three shared signers satisfy the bridge multisig on their own.**
