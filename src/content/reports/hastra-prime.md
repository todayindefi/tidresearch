...
The filings also make the limitations measurable. **$477.536M of $556.033M in certificates — 85.9% — was held by Figure's parent and entities controlled by the parent at 30 June 2026**, against $472.990M of $598.047M (79%) at 31 March. ⚠️ **The certificate book shrank 7.0% over the quarter and the whole contraction was external.** Hastra's own YLDS cannot be assigned to that bucket: the filings never place Signum Ltd. inside the “affiliate entities controlled by the Parent” set, so this report does not count its holdings there. Board and executive holdings were only about $15,700, so this is entity concentration, not insider ownership. FCC reported just $292K of equity on a $601.8M balance sheet because its parent pays operating expenses directly, including $471K during Q1, and records them as capital contributions. That structure is designed to pass assets and obligations through; it should not be misread as immediate distress. The risk is continued parent dependence.
