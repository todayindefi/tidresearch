...
wrapper holds a large claim on the lending pool, enough to cover the current queue
several times over, but turning that claim into dollars still requires an administrator
