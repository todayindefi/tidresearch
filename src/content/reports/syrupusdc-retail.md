...
- **2026-08-23 — borrower concentration measured; no score change.** HHI **1,371–1,533**, unconcentrated, against syrupUSDT's **2,911** with its top three at **90.77%** across seven borrowers. **16 borrowers in syrupUSDC against 7 in syrupUSDT**, with shared names across both pools, so the sizing unit is the family loan book rather than the per-pool number.
