...
- **Its dividend funding now leans on a cash → BTC-stack sequence, not only equity issuance.** Strategy's ATM equity leg has weakened — canonical mNAV (EV/BTC) has crossed into **parity (≈1.02)**, so issuance is no longer reliably accretive — and on 2026-05-05 Saylor committed to a funding mix that draws cash on hand first and then **opportunistic BTC sales** for preferred-dividend service. The practical effect for STRC holders: dividend sustainability increasingly depends on the BTC stack size + price after the cash buffer, on top of capital-markets access. Strategy holds **~847,362 BTC** (about $51.9B at ≈$61.3K) and — importantly — its **USD cash reserve has built to $1.4B (06-21)**, extending near-term coverage to ~9.8 months; see "How much runway?" below for the math. STRC remains barely a year old and the BTC-sale funding leg is similarly new — neither has been tested through a sustained BTC bear, and June 2026 became the first real stress on the new regime: STRC fell to a **fresh all-time low (~$76, about −24% to par)**, sustained sub-$95 for weeks, with mNAV crossing into parity. That novelty plus the live, deep de-anchoring and the parity crossing is the core of the **Underlying score (2.5)** — though note the issuer's cash position improved into the stress, which is why it's instrument-price stress, not a credit event.
...
| Underlying | 2.5 | **Cut from 3.0 (June 2026: raw STRC 4.5 → 4.0 on the mNAV parity crossing); was 4.5 pre-June.** STRC is a real Nasdaq/SEC-registered preferred with a functioning ≈11.5% dividend and par-anchor — but June 2026 is the first live stress test of the new funding mix, and STRC has fallen to a **fresh all-time low (~$76, about −24% to par)**, sustained sub-$95 for weeks, with the July reset a locked +50bp hike. Strategy's **mNAV (EV/BTC) crossed from premium into parity (~1.02)**, so STRC's upstream funding engine is now roughly neutral and its counterparty/credit look-through worsened — the internal raw-STRC score stepped to 4.0. The issuer's cash reserve **built to $1.4B**, so this is instrument-price stress, not a credit event; that offset caps the cut to a half-notch. The STRC credit / mNAV / BTC-bid risk flows through 1:1. A durable mNAV bounce above ~1.05 reverts this; a sustained move into discount would drop it further. |
...
| **Overall** | **2.0** | **Significant risk.** **Cut from 2.5 (June 2026: mNAV parity crossing)** as the underlying STRC look-through dropped a half-notch (Underlying), root-traced to the raw-STRC rescore (Overall 4.5 → 4.0) on the mNAV crossing from premium into parity — the wrapper-specific layers are unchanged. For a non-US holder willing to size around the verified Solana depth (clean-exit ceiling around $30–50K per trade, eroding pool composition), STRCx is a thin but functioning yield-capturing on-chain proxy for STRC, now carrying a deeply de-anchoring underlying (−24% to par) on top of Backed counterparty + custodian risk. For a US person or Ethereum-only holder, it remains a near one-way trade. This is a downgrade on underlying instrument credit look-through, not a wrapper failure — and the offsetting positive is real: the issuer's cash reserve built to $1.4B and issuance stayed paused, so the funding model is at its inflection, not broken. A durable mNAV bounce above ~1.05 reverts it; a sustained move into discount or an accelerated forced-BTC-sale regime would drop it further. |
...
- **mNAV (EV/BTC, currently ~1.02 — PARITY).** This is Strategy's published mNAV; ATM equity issuance is accretive while it stays comfortably above 1.0. It has crossed from premium through the ~1.05 floor into parity, where the accretive equity leg is no longer reliable (the cut this pass). The binding threshold now is a **durable bounce back above ~1.05** (reverts the parity notch) versus a **sustained move into discount (< 0.95)**, which deepens the BTC-bid-flywheel inversion; sustained < 0.85 = distress. (Note: the MktCap/BTC "coverage" ratio of ~0.86 that circulated earlier is a leverage lens, not mNAV — don't read it as discount.)
