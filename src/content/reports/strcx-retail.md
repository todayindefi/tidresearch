...
- **mNAV (EV/BTC, currently roughly 0.99 — just below parity).** This is Strategy's published mNAV; ATM equity issuance is accretive while it stays comfortably above 1.0. It recovered to ~1.01 on the 06-29 8-K and has hovered around the 1.0 line since, printing 0.9852 at the 07-17 close with MSTR about flat at $94.85. This is a **watch, not a break** — the downgrade re-opens only on a *sustained* sub-1.0 **with the reserve drawing down**, and the reserve is instead at a record $3.225B. The binding thresholds: a **durable bounce back above ~1.05** reverts the 06-26 parity notch; a **sustained sub-1.0 with reserve drawdown** re-opens the downgrade; sustained < 0.85 = distress. (Note: the MktCap/BTC "coverage" ratio of ~0.86 that circulated earlier is a leverage lens, not mNAV — don't read it as discount.)
