...
Until today this section said Agora used *"a different key per chain, which is genuine containment: a single compromise reaches one deployment rather than all nine."* **That is false.** Re-measured on 2026-08-22, the ProxyAdmin owner on **Ethereum, Arbitrum, Base, Polygon and Fraxtal is the same address** — `0x68898B77…30e2`. Only Avalanche runs a distinct key.
...
**So the containment credit is withdrawn. A single compromise reaches at least five chains, not one.**
