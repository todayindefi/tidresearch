...
| Liquidity & Exit | 6.0 | **Scored on the worse of the two legs.** The primary leg — permissionless mint and redeem at the vault layer, no KYC — scores 6.5 and is not what sets the axis. Venue depth is the binding one at 6.0. ⚠️ **No exit ladder is published for this pool at all**, and syrupUSDC's stops at $100,000, so venue depth is untested at institutional sizing on either side of the comparison. ⚠️ **The cushion runs thin and variable here:** a median of **0.89%** across 352 hour-bucketed readings since 2026-09-11, under 2% in **61% of hours**, and **0.18% at the most recent reading** — close to its own 0.16% floor. **The 6.0 is not moved** — absent a depth measurement at size, replacing one unevidenced number with another would invent precision twice. **A ladder at institutional notional is commissioned for both pools, and it decides the ordering.** |
