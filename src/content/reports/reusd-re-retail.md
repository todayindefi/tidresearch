...
⚠️ **Not established, and not to be inferred from the above:** a dollar value for reUSDe. The token count is solid at 14,012,171 but its NAV conversion is not, so no restated mezzanine figure appears here.
...
| Mezzanine — reUSDe (second loss) | about **$19M** | live supply × NAV |
