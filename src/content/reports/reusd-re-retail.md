...
**Now established, and the earlier refusal is lifted.** This report previously declined to give a dollar value for reUSDe because the NAV conversion was not confirmed. ⚠️ **Measured 2026-08-27: 14,094,070 reUSDe at a NAV of 1.408519 = $19.85M** — and the NAV is corroborated two independent ways, Re's `/tvl` implying 1.408519 against measured supply and CoinGecko printing $1.41, 0.03% apart. **That is 9.14% of the senior tranche.** The earlier 14,012,171 count was close but is superseded; see the [reUSDe report](/reports/reusde-re/) for the full assessment.
...
- **2026-08-27 — senior and mezzanine both re-measured; the sibling report is now published; no score change.** The Ethereum leg reads **198,103,604 reUSD at NAV 1.096411 = about $217.2M**, superseding the 08-25 figure of $207.0M across 188.8M tokens. Re's `/tvl` reports **$233.7M all-chain**, now labelled issuer-reported. ⚠️ **The mezzanine dollar value this report previously refused to state is now established: 14,094,070 reUSDe at NAV 1.408519 = $19.85M, or 9.14% of the senior tranche.** The refusal was correct at the time — the NAV conversion was unconfirmed — and it is lifted because **CoinGecko and Re's own endpoint now corroborate the NAV to 0.03%.** ⚠️ **The waterfall table's "about $19M" was accidentally right, and that is worth recording rather than quietly fixing.** It was a May figure: 14.24M tokens at about $1.34. Since then supply fell and NAV rose, and the product barely moved. **An unchanged number is not evidence of a checked number**, and this one hid a real change in the tranche's composition — including a July redemption window through which roughly 4.7% of it left. **The five links removed on 2026-08-26 are restored**, now that [reUSDe](/reports/reusde-re/) is published.
- **2026-08-26 — five dead links removed; no score or figure changes.** This report linked to a standalone reUSDe page five times — in the tranche description, the watch list, the waterfall paragraph and the waterfall table. ⚠️ **That page is not published, so every one of those links returned a 404 on the live site** — and they sat in the passages doing the most work, since reUSDe is the mezzanine tranche that absorbs losses before reUSD does. **A reader following one of those links is precisely the reader checking whether the buffer beneath them is real.** The links are removed rather than repointed, and **the reUSDe coverage was deliberately not published to fix them**: that draft was last verified 2026-05-18, and publishing a hundred-day-old assessment to satisfy a link trades a visible 404 for an invisible staleness, which is the worse of the two. ⚠️ **Related, and not fixed here: the about $19M mezzanine figure in the waterfall table shares that draft's May basis.** It is labelled *live supply × NAV* but was not re-measured in this pass, and it is the denominator of reUSD's loss buffer. Treat it as dated until re-read.
- **2026-08-25 — senior tranche re-read; figures refreshed; scores held at 6.0, explicitly a hold rather than a pass.** The Ethereum leg alone now measures **188,824,946 reUSD at NAV 1.096411, about $207.0M** — up from $205.3M two days ago, and still a **floor** since all-chain is higher. Attachment on Re's published junior sizes moves to **37.19%** on the $77M basis and **9.66%** on the $20M basis, still below the 10% norm this report invokes. ⚠️ **The framing is unchanged and still the point: capacity outpacing subordination, not deterioration.** No loss occurred, the junior layer did not shrink, and the ratio thinned because the denominator rose again. ⚠️ **And 9.66% remains indicative rather than measured**, for the same reason as before: Re's junior figures are from **June** while the senior read is current, so it still divides a two-month-old numerator by a fresh denominator. Two more days of senior growth has not turned that into a measurement. `last_verified` is bumped to 2026-08-25 for the senior-tranche figures; the junior sizes, NAV-oracle and audit material still date from the passes recorded below. **An earlier version of this entry left the stamp at 2026-08-18** on the reasoning that only part of the body was re-read — which was inconsistent with the nine other reports refreshed in the same batch, and left the index card showing a date older than the content beneath it.
- **2026-08-23 — senior tranche re-measured; subordination has thinned on both sides; no score change.** The **Ethereum leg alone** reads **188,824,946 reUSD at NAV 1.096411 = about $207.0M**, against the **$181M all-chain** figure this report carried — so all-chain is higher still and the published number is superseded by a floor. Held against Re's published junior sizes, the attachment point moves: **$77M product-page junior falls from 42.5% to 37.5%**, and the **$20M implied by the loss-scenario page falls from 11.0% to 9.7% — below the 10% institutional norm this report itself invokes**, on the smaller-number sizing basis the report recommends. ⚠️ **This is capacity outpacing subordination, not deterioration.** No loss occurred and the junior layer did not shrink; senior deposits grew about 13% and the ratio thinned because the **denominator** rose. Growth reads as demand and health, which is exactly why it would pass unnoticed — the third instance today of a ratio moving for reasons that do not mean what they look like, after [Figure](/reports/figure/) (denominator grew, headline improved) and [wYLDS](/reports/wylds/) (denominator shrank, coverage improved). ⚠️ **The 9.7% is indicative rather than measured, and the page says so:** the junior figures are Re's as of **June 2026** while the senior read is **2026-08-23**, so the ratio divides a two-month-old numerator by a current denominator. Re's junior capital was not re-measured and there is no on-chain handle on it. Direction solid; threshold crossing not precisely dated. **No axis moves, checked directly rather than assumed:** Structural 6.0 rests on the closed audit gap, the verified 48-hour timelock, the NAV admin write path and the off-chain dependency stack, and **cites depth of subordination nowhere**; the only tranche reference in any rationale is Overall's "disclosed and sized", which is the fact of disclosure rather than the ratio — and disclosure is unchanged. **Hold made checkable:** junior-to-senior below 9% on the scenario basis, a confirmed contraction in the mezzanine layer, or Re confirming that $20M rather than $77M governs the attachment schedule. ⚠️ **Not established and deliberately not published:** a dollar value for reUSDe. The token count is solid at 14,012,171; the NAV conversion is not, so no restated mezzanine figure appears. `last_verified` is not bumped — only the senior tranche was re-read.
