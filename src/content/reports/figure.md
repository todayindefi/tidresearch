...
**UMB still holds the investments on deposit** — $555,722K under Schedule V, alongside $5,488K of cash at Lead Bank and $700K at Flagstar Bank, N.A. ⚠️ **And the Lead Bank line is a custody fact rather than a cash balance.** Schedule V footnote (2) reads: *"The Lead Bank account is held by **Figure Pay** and includes amounts related to **affiliated entities**. The amount disclosed represents only the portion attributable to FCC and does not reflect the total balance maintained by Figure Pay."* **So about 1% of a regulated issuer's qualified assets sits in a commingled account held by an affiliate, with FCC's share established by allocation rather than segregation** — small in dollars, but the Investment Company Act §28 deposit requirement is an asset test, and an allocated share of someone else's account is a different kind of asset from a segregated one. **So custody and repo used to be the same name and are now two, and only custody is still UMB.** ⚠️ **$200M of a regulated retail certificate issuer's qualified assets now sits in overnight repo with a counterparty that is not the bank holding its custody.**
...
⚠️ **Two limits on the above, stated rather than left implicit.** Those financials are **2025-12-31 against a 2026-06-30 exposure**, and the firm **registered as a security-based swap entity on 2026-09-10** (SBSE-BD and SBSE-C), which is a change in what it does. ⚠️ **The same filing also discloses $100M of repo outstanding with Ripple itself at 2025-12-31** — small against a $37.77B book, but its own repo counterparty list includes its parent. The assets were $211.3M of Treasuries and money-market funds plus $389.556M of overnight Treasury-collateralized repo, with no Level 3 holdings.
...
At 30 June 2026, **$477.536M of $556.033M in certificates — 85.9% — was held by Figure's parent and controlled entities**, up from 79% at 31 March. ⚠️ **The concentration rose because outside holders left, not because affiliates grew — and the single-quarter move is the finding.** Three dates, because a change between two of them hides it:

| | related party | third party | total | related share |
|---|---:|---:|---:|---:|
| 31 Dec 2025 | $252.282M | $75.911M | $328.193M | 76.9% |
| 31 Mar 2026 | $472.990M | $125.057M | $598.047M | 79.1% |
| 30 Jun 2026 | $477.536M | $78.497M | $556.033M | **85.9%** |

⚠️⚠️ **Across Q2 the third-party leg fell 37.2% while the related-party leg grew 1.0%, and the whole certificate book shrank 7.0%.** **Outside holders redeemed more than a third of their position in a single quarter, and that is why the affiliate share rose.** ⚠️ **The Dec-to-Jun window the 10-Q prints as its comparative shows third-party holdings up 3.4% — arithmetically true and the opposite of the quarter it contains.** The filings do not put Hastra in that set. This is entity concentration, not director or executive ownership.
